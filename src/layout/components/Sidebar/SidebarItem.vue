...
.el-submenu.is-active > .el-submenu__title {
  color: #f4f4f5 !important; // $subMenuActiveText !important;
}

.full-mode {
  .nest-menu .el-submenu>.el-submenu__title,
  .el-submenu .el-menu-item {
    min-width: 210px !important; // $sideBarWidth !important;
    background-color: #1f2d3d !important; // $subMenuBg !important;

    &:hover {
      background-color: #001528 !important; // $subMenuHover !important;
    }
  }
}
